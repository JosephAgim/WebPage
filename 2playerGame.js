...
function setup(){
 ...
 function draw() {
    ...
    if (x-10 > 0 && keyIsDown(65)) {
        x -= 10;
        //moves left
    }
    if (x+10 < 400 && keyIsDown(68)) {
        x += 10;
        //moves right
    }
    if (y-10 > 0 && keyIsDown(87)) {
        y -= 10;
        //moves up
    }
    if (y+10 < 400 && keyIsDown(83)) {
        y += 10;
        //moves down
    }
    if (bx-10 > 0 && keyIsDown(37)) {
        bx -= 10;
        //moves right
    }
    if (bx+10 < 400 && keyIsDown(39)) {
        bx += 10;
        //moves left
    }
    if (by-10 > 0 && keyIsDown(38)) {
        by -= 10;
        //moves up
    }
    if (by+10 < 400 && keyIsDown(40)) {
        by += 10;
        //moves down
    }
